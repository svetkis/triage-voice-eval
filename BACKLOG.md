...
### [ ] #3 encoding="utf-8" при чтении файлов
- **Файлы:**
...
### [ ] #4 Конфликт `model_config_override` с Pydantic v2
...
### [ ] #7 `RunResult.timestamp` → `datetime` + trend сортирует по нему
...
### [ ] #8 `JailbreakGuard`: убрать fallback на `str(response)`
...
### [ ] #11 `Scenario.from_yaml` — обернуть валидацию тоже
...
### [ ] #12 Согласовать стиль импортов — относительные в `reports/*`
...
### [ ] #13 Унифицировать стиль аннотации `name`
...
### [ ] #17 `response: dict` → `dict[str, Any]` в guards
